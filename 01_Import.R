# This script downloads the required data from the internet
...
download.file("https://raw.githubusercontent.com/arilamstein/complexsurvey/master/brfss_state.csv", 
  CSVPATH)
...
download.file("https://www2.census.gov/programs-surveys/popest/tables/2010-2016/state/totals/nst-est2016-01.xlsx", 
  CENSUS_PATH)
census <- readWorkbook(CENSUS_PATH, sheet = 1, startRow = 1, 
  colNames = TRUE, rowNames = FALSE, detectDates = FALSE, skipEmptyRows = TRUE, 
