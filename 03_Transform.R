...
brfss.survey1 <- brfss.survey1 %>%
  mutate(interview.date = as.Date(IDATE, "%m%d%Y"),
         ...
         income = car::recode(INCOME2, "1='<$10,000'; 2='<$15,000'; 3='<$20,000'; 4='<$25,000'; 5='<$35,000'; 6='<$50,000'; 7='<$75,000'; 8='>$75,000'; 77='DK/NS'; 99=NA"),
         ...
         self.hlth.level = car::recode(GENHLTH, "1='Excellent'; 2='Very good'; 3='Good'; 4='Fair'; 5='Poor'; 7='DK/NS'; 9=NA"),
         ...
         diff.dressing = car::recode(DIFFDRES, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         diff.dressing = as.factor(diff.dressing),
         diff.decisions = car::recode(DECIDE, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         ...
         life.satisfied = car::recode(LSATISFY, "1='Very satisfied'; 2='Satisfied'; 3='Dissatisfied'; 4='Very dissatisfied'; 7='DK/NS'; 9=NA"),
         ...
         days.energetic = car::recode(QLHLTH2, "88='0'; 77='DK/NS'; 99=NA"),
         ...
         days.use.marij = car::recode(MARIJANA, "77='DK/NS'; 88='0'; 99=NA"),
         ...
         risky.behavior = car::recode(HIVRISK4, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         risky.behavior = as.factor(risky.behavior),
         diag.nonskin.cancer = car::recode(CHCOCNCR, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
