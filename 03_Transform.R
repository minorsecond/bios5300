...
brfss.survey1 <- brfss.survey1 %>%
  mutate(race.eth = car::recode(X_RACEGR3, "1='White only, Non-Hispanic'; 2='Black only, Non-Hispanic'; 3='Other race only, Non-Hispanic'; 4='Multiracial, Non-Hispanic'; 5='Hispanic'; 9=NA"),
...
brfss.survey1 <- brfss.survey1[, c("X_LLCPWT", "X_STSTR", "X_PSU", "STATE", 
                                   "race.eth", "age.grp", "sex", 
                                   "daily.sleep.hrs", "diag.depression", 
                                   "diag.stroke", "days.anxious",
                                   "alc.heavy.drinker", "smoker.status")]
