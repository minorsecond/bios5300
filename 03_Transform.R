...
brfss.survey1 <- brfss.survey1 %>%
  mutate(interview.date = as.Date(IDATE, "%m%d%Y"),
         ...
         income = car::recode(INCOME2, "1='<$10,000'; 2='<$15,000'; 3='<$20,000'; 4='<$25,000'; 5='<$35,000'; 6='<$50,000'; 7='<$75,000'; 8='>$75,000'; 77='DK/NS'; 99='Refused'"),
         income = as.factor(income),
         sex = car::recode(SEX, "1='Male'; 2='Female'; 9=NA"),
         sex = as.factor(sex),
         bmi = X_BMI5 / 100,
         edu.level = car::recode(EDUCA, "1='Never attended school or only kindergarten'; 2='Grades 1 through 8 (Elementary) '; 3='Grades 9 through 11 (Some high school) '; 4='Grade 12 or GED (High school graduate) '; 5='College 1 year to 3 years (Some college or technical school)'; 6='College 4 years or more (College graduate) '; 9='Refused'"),
         edu.level = as.factor(edu.level),
         n.children = car::recode(X_CHLDCNT, "1='No children in household'; 2='One child in household'; 3='Two children in household'; 4='Three children in household'; 5='Four children in household'; 6='Five or more children in household'; 9=NA"),
         n.children = as.factor(n.children),
         self.hlth.level = car::recode(GENHLTH, "1='Excellent'; 2='Very good'; 3='Good'; 4='Fair'; 5='Poor'; 7='DK/NS'; 9='Refused'"),
         ...
         diff.walking = car::recode(DIFFWALK, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         diff.walking = as.factor(diff.walking),
         diff.dressing = car::recode(DIFFDRES, "1='Yes'; 2='No'; 7='DK/NS'; 9='Refused'"),
         diff.dressing = as.factor(diff.dressing),
         diff.decisions = car::recode(DECIDE, "1='Yes'; 2='No'; 7='DK/NS'; 9='Refused'"),
         diff.decisions = as.factor(diff.decisions),
         diff.errands.alone = car::recode(DIFFALON, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         ...
         daily.sleep.hrs = car::recode(SLEPTIM1, "77='DK/NS'; 99 =NA"),
         diag.depression = car::recode(ADDEPEV2, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         ...
         life.satisfied = car::recode(LSATISFY, "1='Very satisfied'; 2='Satisfied'; 3='Dissatisfied'; 4='Very dissatisfied'; 7='DK/NS'; 9='Refused'"),
         ...
         days.pain.prev.phys.act = car::recode(PAINACT2, "88='0'; 77='DK/NS'; 99='Refused'"),
         diag.stroke = car::recode(CVDSTRK3, "1=1; 2=0; 7=NA; 9=NA"),
         diag.stroke = as.factor(diag.stroke),
         marital.status = car::recode(MARITAL, "1='Married'; 2='Divorced'; 3='Widowed'; 4='Separated'; 5='Never married'; 6='A member of an unmarried couple'; 9='Refused'"),
         marital.status = as.factor(marital.status),
         veteran = car::recode(VETERAN3, "1='Yes'; 2='No'; 7=NA; 9=NA"),
         veteran = as.factor(veteran),
         days.use.marij = car::recode(MARIJANA, "77='DK/NS'; 88='0'; 99='Refused'"),
         alc.binge = car::recode(X_RFBING5, "1='Yyes'; 2='No'; 9='DK/NS/Refused/Missing'"),
         ...
         smoker.status = car::recode(X_SMOKER3, "1 = 'Current smoker - now smokes every day'; 2='Currentsmoker - now smokes some days'; 3='Former smoker'; 4='Never smoked'; 9=NA"),
         smoker.status = as.factor(smoker.status),
         smoker.100.cigs.life = car::recode(SMOKE100, "1='Yes'; 2='No'; 7='DK/NS'; 9=NA"),
         smoker.100.cigs.life = as.factor(smoker.100.cigs.life),
         risky.behavior = car::recode(HIVRISK4, "1='Yes'; 2='No'; 7='DK/NS'; 9='Refused'"),
         risky.behavior = as.factor(risky.behavior),
         diag.nonskin.cancer = car::recode(CHCOCNCR, "1='Yes'; 2='No'; 7='DK/NS'; 9='Refused'"),
...
brfss.survey1 <- brfss.survey1[, c("X_LLCPWT", "X_STSTR", "X_PSU", "STATE", "interview.date", 
                                   ...
                                   "marital.status", "alc.binge", "alc.n.drinks.weekly",
                                   "alc.heavy.drinker", "smoker.status", "smoker.100.cigs.life",
                                   "veteran")]

# Prompt to remove outliers. I did in my tests
outlierKD(brfss.survey1, bmi)
outlierKD(brfss.survey1, alc.n.drinks.weekly)
outlierKD(brfss.survey1, as.integer(daily.sleep.hrs))
