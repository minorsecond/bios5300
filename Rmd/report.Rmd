...
is the probability that a stroke will occur. The result of the logistic regression model were then exponentiated to produce the odds ratios (OR) reported within this paper.
